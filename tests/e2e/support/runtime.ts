...
// A raster image: SVG uploads are denied at the app layer, so the seed/specs must upload
// an allowed image type for memory media to attach.
export const memoryFixturePath = resolve('tests/e2e/fixtures/memory-photo.png');
