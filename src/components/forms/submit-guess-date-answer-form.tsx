...
const buildSubmitGuessDateAnswerSchema = (
  t: ReturnType<typeof useI18n<"forms.guessDate">>["t"],
) =>
  z.object({
    guessedDate: z
      .string()
      .regex(/^\d{4}-\d{2}-\d{2}$/, t("validation.guessedDateRequired")),
    roundId: z.uuid(),
  });

type SubmitGuessDateAnswerValues = z.infer<
  ReturnType<typeof buildSubmitGuessDateAnswerSchema>
>;
