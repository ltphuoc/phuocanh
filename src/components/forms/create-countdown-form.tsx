...
const buildCreateCountdownSchema = (t: ReturnType<typeof useI18n<'forms.countdown'>>['t']) =>
  z.object({
...
const COUNTDOWN_KIND_OPTIONS = ['anniversary', 'birthday', 'travel', 'plan', 'custom'] as const;
