...
const buildSubmitTriviaAnswerSchema = (
  t: ReturnType<typeof useI18n<"forms.trivia">>["t"],
) =>
  z.object({
    roundId: z.uuid(),
...
type SubmitTriviaAnswerValues = z.infer<
  ReturnType<typeof buildSubmitTriviaAnswerSchema>
>;
