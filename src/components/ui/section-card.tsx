...
const sectionCardVariants = tv({
  base:
    "relative overflow-hidden border text-foreground transition-all duration-300 before:absolute before:inset-[1px] before:rounded-[inherit] before:content-['']",
  variants: {
    padding: {
      compact: "p-5 md:p-6",
    ...
    surface: {
      ...
      hero:
        "ui-gradient-hero rounded-[var(--radius-hero)] border-white/55 shadow-cloud before:bg-white/14",
      paper:
