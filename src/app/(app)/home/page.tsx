          ...
          <PageReveal delay={0.05}>
            <section className="flex flex-col gap-6">
              <PageHeader
                ...
                description="A story ribbon for your recent chapters, with images, notes, and dates that feel like keepsakes instead of rows."
                eyebrow="Story ribbon"
                quote="Little details become the chapters you keep reopening."
                surface="paper"
              ...
              {timelineItems.length ? (
                ...
                <EmptyState
                  description="Start your timeline with a note, photo, or short video and it will appear here like a collectible chapter."
          ...
          <div className="flex flex-col gap-6">
            <PageReveal delay={0.1}>
              <SectionCard className="flex flex-col gap-5" padding="comfortable" surface="glass">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className="ui-meta ui-couple-mark">Wish list</p>
                ...
                <div className="flex flex-col gap-3">
                  {data.wishItems.length ? (
                    ...
                    <EmptyState
                      description="Add places, food, or movies that should become your next chapter together."
            ...
            <PageReveal delay={0.15}>
              <SectionCard className="flex flex-col gap-5" padding="comfortable" surface="petal">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    <p className="ui-meta ui-couple-mark">Planning quietly</p>
                    <h2 className="mt-2 font-display text-[2rem] tracking-[-0.03em] text-foreground">
                      Shared checklists
                    </h2>
                  </div>
                ...
                <div className="flex flex-col gap-4">
                  {data.checklists.length ? (
                    data.checklists.map((checklist) => (
                      ...
                      >
                        <div>
                          <p className="ui-meta">Checklist</p>
                    ...
                    <EmptyState
                      description="Create a shared list for your next trip, dinner, or tiny weekly ritual."
